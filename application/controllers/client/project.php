...
class Project extends Client_Controller
{
    ...
    public function saved_project($id = NULL)
    {
        ...
        $data = $this->items_model->array_from_post(array('project_name', 'start_date', 'end_date', 'project_cost', 'demo_url', 'description'));
    ...
    public function send_project_notify_assign_user($project_id, $users)
    {
        ...
        $Link = str_replace("{PROJECT_LINK}", base_url() . 'client/project/project_details/' . $project_id, $assigned_by);
    ...
    public function send_project_notify_client($project_id, $complete = NULL)
    {
        ...
        $Link = str_replace("{PROJECT_LINK}", base_url() . 'client/project/project_details/' . $project_id, $project_name);
        $message = str_replace("{SITE_NAME}", config_item('company_name'), $Link);
