            ...
            <?php if ($display == 'logo' || $display == 'logo_title') { ?>
                <a href="#" class="navbar-brand">
                    ...
                    <div class="brand-logo-collapsed">
                        <img src="<?= base_url() . "uploads/logo-x-white.png" ?>" alt="App Logo"
                             class="img-responsive">
                    </div>
                </a>
            <?php }
                    ...
                    <ul class="dropdown-menu animated zoomIn">
                        <li>
                            ...
                            <div class="list-group">
                                ...
                                <!-- list item-->
                                <a href="<?php echo base_url() ?>admin/mailbox/index/read_inbox_mail/<?php echo $v_email->inbox_id ?>" class="list-group-item">
                                    <div class="media-box">
                                        <div class="pull-left">
