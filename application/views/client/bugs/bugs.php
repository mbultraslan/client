                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a data-toggle="modal" data-target="#myModal"
                                               href="<?= base_url() ?>client/bugs/update_users/<?= $v_bugs->bug_id ?>"
                                        ...
                                        <td>
                                            <?php if (!empty($can_edit)) { ?>
                                                <?php echo btn_edit('client/bugs/index/' . $v_bugs->bug_id) ?>
                                            <?php }
                                            if (!empty($can_delete)) { ?>
                                                <?php echo btn_delete('client/bugs/delete_bug/' . $v_bugs->bug_id) ?>
                                            <?php } ?>
                                            <?php if (!empty($can_edit)) { ?>
                                                <div class="btn-group">
                                                    ...
                                                    <ul class="dropdown-menu animated zoomIn">
                                                        ...
                                                        <li>
                                                            <a href="<?= base_url() ?>client/bugs/change_status/<?= $v_bugs->bug_id ?>/unconfirmed"><?= lang('unconfirmed') ?></a>
                                                        </li>
                                                        <li>
                                                            <a href="<?= base_url() ?>client/bugs/change_status/<?= $v_bugs->bug_id ?>/confirmed"><?= lang('confirmed') ?></a>
                                                        </li>
                                                        <li>
                                                            <a href="<?= base_url() ?>client/bugs/change_status/<?= $v_bugs->bug_id ?>/in_progress"><?= lang('in_progress') ?></a>
                                                        </li>
                                                        <li>
                                                            <a href="<?= base_url() ?>client/bugs/change_status/<?= $v_bugs->bug_id ?>/resolved"><?= lang('resolved') ?></a>
                                                        </li>
                                                        <li>
                                                            <a href="<?= base_url() ?>client/bugs/change_status/<?= $v_bugs->bug_id ?>/verified"><?= lang('verified') ?></a>
                                                        </li>
