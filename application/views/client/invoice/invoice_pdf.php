    ...
    <table style="width: 100%; vertical-align: middle;">
        <tr>
            ...
            <td style=" border: 0px;padding-bottom: 10px;">
                <img style="width: 300px; px;margin-top: -10px;margin-right: 10px;"
...
<tfoot>
      <tr>
                    <th  colspan="5" style="border:0px;text-align: right"><?= $language_info['sub_total'] ?> :</th>
                    <td style="border:0px"> <?= display_money($this->invoice_model->calculate_to('invoice_cost', $invoice_info->invoices_id), $currency->symbol) ?></td>
                </tr>
                ...
                if ($paid_amount > 0.00) {
                    ?>
                    <tr>
                        <td colspan="5" style="text-align: right"><strong><?= $language_info['payment_made'] ?></strong></td>
                        <td><?= $paid_amount ?> </td>
                    </tr>
                    <?php
                }
                ...
                ?>
                <tr>
                    <td colspan="5" style="text-align: right"><strong><?= $language_info['total'] ?> :</strong></td>
...
<p class="notes" style="margin-top: 100px;">
                <?= $invoice_info->notes ?>
            </p>
</body>
</html>
