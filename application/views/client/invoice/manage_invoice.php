            ...
            if (!empty($all_invoices_info)) {
                foreach ($all_invoices_info as $v_invoices) {
                    ...
                    <tr>
                        ...
                        <?php $curency = $this->invoice_model->client_currency_sambol($v_invoices->client_id); ?>
                        <td><?= display_money($this->invoice_model->calculate_to('invoice_cost', $v_invoices->invoices_id), $curency->symbol) ?></td>
